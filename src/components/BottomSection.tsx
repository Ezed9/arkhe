  ...
  return (
    ...
    >
      <div className="w-full flex justify-center md:justify-end md:pr-[8%]">
        <p className="font-mono text-[10px] md:text-[11px] uppercase tracking-[0.15em] leading-[1.8] max-w-[520px] text-center md:text-left pointer-events-auto" style={{ color: 'rgba(255,255,255,0.35)' }}>
      ...
      <div className="w-full flex justify-center md:justify-end pointer-events-auto">
        <span className="font-mono text-[8px] md:text-[9px] uppercase tracking-[0.3em]" style={{ color: 'rgba(255,255,255,0.22)' }}>
